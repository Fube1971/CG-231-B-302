    ...
    /**
     * funcion sin el reflejo
     */

    /**
     * 
     * @param {numero de caras} faces 
     * @param {numero de esquinas} edges coge las esquinas como las caras
     * @param {tamanio de aristas} size 
     * @returns 
     */
    ...
    const geometry = createPolyhedronGeometry(2, 4, 1);
    ...
    //Comentada funcion que muestra figura reflejada
    /**
     * 
     * @param {Numero de caras} faces 
     * @param {Numero de esquinas} edges  coge las esuinas como las caras
     * @param {Largo de aristas} size 
     * @returns Geometria de un Polyedro
     */
 /* function createPolyhedronGeometry(faces, edges, size) {
      const vertices = [];
      const indices = [];
